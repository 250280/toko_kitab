<?php
class sales_transaction_report_model extends CI_Model 
{
	...
	{		
		...
		where (a.transaction_type_id = 2 or a.transaction_type_id = 3 or a.transaction_type_id = 4 or a.transaction_type_id = 5 or a.transaction_type_id = 6)
		and transaction_active_status = 1 
		$where  $order_by
	...
	function delete($id)
	{
		...
		$this->db->delete('sales_transaction_report_items');
	...
	function update($id, $data, $items)
	{
		...
		{			
			...
			$this->db->insert('sales_transaction_report_items', $row); 
			$index++;
		}
