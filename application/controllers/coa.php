...
{	
	function __construct()
	{
		...
		$this->access->set_module('accounting.coa');
	...
	function coa_form($id=0)
	{
		...
		$this->render->show('Coa', 'Ubah Account');
	} 
	...
	function coa_form_action($is_delete=0)
	{
		...
		if(empty($id))
		{
			...
			$this->form_validation->set_rules('i_coa_name','Nama Coa','trim|min_length[3]|max_length[100]|required');	
