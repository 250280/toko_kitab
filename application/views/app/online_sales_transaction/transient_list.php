...
$(function(){
	createTableFormTransient({
		...
		listSource 		: "online_sales_transaction/detail_list_loader/<?=$row_id?>",
		formSource 		: "online_sales_transaction/detail_form/<?=$row_id?>",
		controlTarget	: "online_sales_transaction/detail_form_action",
