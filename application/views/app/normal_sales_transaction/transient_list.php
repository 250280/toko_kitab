...
$(function(){
	createTableFormTransient({
		...
		listSource 		: "normal_sales_transaction/detail_list_loader/<?=$row_id?>",
		formSource 		: "normal_sales_transaction/detail_form/<?=$row_id?>",
		controlTarget	: "normal_sales_transaction/detail_form_action",
