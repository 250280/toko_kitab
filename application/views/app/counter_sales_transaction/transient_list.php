...
$(function(){
	createTableFormTransient({
		...
		listSource 		: "counter_sales_transaction/detail_list_loader/<?=$row_id?>",
		formSource 		: "counter_sales_transaction/detail_form/<?=$row_id?>",
		controlTarget	: "counter_sales_transaction/detail_form_action",
