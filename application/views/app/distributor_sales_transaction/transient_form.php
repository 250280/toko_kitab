...
$(function(){
	createLookUp({
		...
		listSource 		: "lookup/active_product_table_control/5/" + $('input[name="i_stand_id"]').val(),
	...
	function load_product_stock(id){
		...
		$.ajax({
			type: 'POST',
			url: '<?=site_url('distributor_sales_transaction/load_product_stock')?>',
			data: data,
			dataType: 'json',
...
<table class="form_layout">
	<tr>
	 ...
	 <span class="lookup" id="lookup_active_product">
        ...
        <input type="hidden" name="i_product_stock_id" value="" />
