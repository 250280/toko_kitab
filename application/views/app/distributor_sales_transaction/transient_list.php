...
$(function(){
	createTableFormTransient({
		...
		listSource 		: "distributor_sales_transaction/detail_list_loader/<?=$row_id?>",
		formSource 		: "distributor_sales_transaction/detail_form/<?=$row_id?>",
		controlTarget	: "distributor_sales_transaction/detail_form_action",
