...
<table class="form_layout">
  ...
  <tr>
    ...
    <td>
      <input name="i_coa_hierarchy2" type="text" id="i_coa_hierarchy2" value="<?=$coa_code?>" size="10" maxlength="" style="width:60% !important" />
      <input name="i_coa_hierarchy" type="text" id="i_coa_hierarchy" value="<?=$parent_coa_hierarchy?>" size="20" maxlength="<?=$coa_hierarchy?>" readonly="readonly" style="width:20% !important;" /></td>
  </tr>
  <tr>
