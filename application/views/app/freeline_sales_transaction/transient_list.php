...
$(function(){
	createTableFormTransient({
		...
		listSource 		: "freeline_sales_transaction/detail_list_loader/<?=$row_id?>",
		formSource 		: "freeline_sales_transaction/detail_form/<?=$row_id?>",
		controlTarget	: "freeline_sales_transaction/detail_form_action",
